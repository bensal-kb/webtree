...
class WeatherWeeklyForecast extends StatelessWidget with BaseUI {
  const WeatherWeeklyForecast({super.key, required this.weatherModel});
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ListView(
              ...
              children: [
                for (Days i in weatherModel.days!.sublist(0, 7))
                  Container(
                    width: 50,
                    ...
                    child: Column(
                      children: [
                        const Spacer(flex: 1),
                        Text(
                          DateTimeUtils.getFormattedDateFromStr(i.datetime!),
                          style: textStyle(
