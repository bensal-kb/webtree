...
WeatherModel copyWith({  num? queryCost,
  num? latitude,
  num? longitude,
  String? resolvedAddress,
  String? address,
  ...
  Stations? stations,
  CurrentConditions? currentConditions,
}) => WeatherModel(  queryCost: queryCost ?? this.queryCost,
...
class Stations {
  ...
  Stations.fromJson(dynamic json) {
    vobg = json['VOBG'] != null ? Vobg.fromJson(json['VOBG']) : null;
    av611 = json['AV611'] != null ? Av611.fromJson(json['AV611']) : null;
    vobl = json['VOBL'] != null ? Vobl.fromJson(json['VOBL']) : null;
  }
  Vobg? vobg;
  Av611? av611;
  Vobl? vobl;
Stations copyWith({  Vobg? vobg,
  Av611? av611,
  Vobl? vobl,
}) => Stations(  vobg: vobg ?? this.vobg,
  av611: av611 ?? this.av611,
  vobl: vobl ?? this.vobl,
);
  Map<String, dynamic> toJson() {
    final map = <String, dynamic>{};
    if (vobg != null) {
      map['VOBG'] = vobg?.toJson();
    }
    if (av611 != null) {
      map['AV611'] = av611?.toJson();
    }
    if (vobl != null) {
      map['VOBL'] = vobl?.toJson();
    }
    return map;
  }
...
Vobl copyWith({  num? distance,
  ...
  num? quality,
  num? contribution,
}) => Vobl(  distance: distance ?? this.distance,
  latitude: latitude ?? this.latitude,
  longitude: longitude ?? this.longitude,
...
Av611 copyWith({  num? distance,
  ...
  num? quality,
  num? contribution,
}) => Av611(  distance: distance ?? this.distance,
  latitude: latitude ?? this.latitude,
  longitude: longitude ?? this.longitude,
  useCount: useCount ?? this.useCount,
  id: id ?? this.id,
...
Vobg copyWith({  num? distance,
  ...
  num? quality,
  num? contribution,
}) => Vobg(  distance: distance ?? this.distance,
  latitude: latitude ?? this.latitude,
  longitude: longitude ?? this.longitude,
  useCount: useCount ?? this.useCount,
  id: id ?? this.id,
